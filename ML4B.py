...
# Core + extended schema library (same as before)
...
# ... keep your full schema list here ...
# (For brevity, I’m leaving your expanded schemas intact)
...
# --- your SCHEMAS and SCHEMA_KEYWORDS should remain here ---
